...
**Not included:** sections 1-3 and 5-6, which the reviewer has already verified
**Return:** updated docs/GUIDE.md; reviewer verifies length and line-width constraints only
