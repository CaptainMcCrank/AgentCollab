#!/usr/bin/env python3
"""acp-lint.py — validate AgentCollab protocol blocks against schemas/.
...
Usage:
  acp-lint.py FILE [FILE ...]      validate every recognized block in each file
  acp-lint.py --json FILE          print parsed JSON for each block, then validate
